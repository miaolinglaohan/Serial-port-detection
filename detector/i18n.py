...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    'zh': {
        ...
        'mode_value_auto': '智能混合',
        'mode_value_passive': '被动监听',
        'mode_value_active': '主动探测',
        'btn_start': '▶️ 开始黑盒探测',
        'btn_stop': '⏹️ 停止探测',
        'btn_stopping': '⏳ 正在停止...',
        'controls_title': '控制面板',
        ...
        'databits_title': '数据位 (Data Bits):',
        'chk_databits_8': '8 Bit (默认)',
        'chk_databits_7': '7 Bit',
        ...
        'best_card_detail_testing': '正在全矩阵扫描算法对比中 (当前模式: {mode})...',
        'virtual_port_detected_title': 'ℹ️ 检测到软件虚拟串口: 推荐 {baud} bps | {param}',
        'virtual_port_detected_detail': '虚拟串口通过内存传输数据，不受硬件波特率限制，因此所有波特率设置均能成功通信。推荐使用标准 {baud} bps。',
        'log_virtual_port_notice': 'ℹ️ 智能分析: 当前串口为软件虚拟串口通道，多组波特率均完美连通。',
        'best_card_title_stopping': '⏳ 正在停止探测...',
        'best_card_detail_stopping': '已收到停止指令，正在关闭当前串口读取并结束扫描。',
        ...
        'table_score': '置信度得分',
        'table_param': '串口参数 (波特率, 校验位)',
        'table_protocol': '识别协议/特征',
        'table_mode': '探测方式',
        'table_ascii_ratio': 'ASCII可读率',
        'table_details': '匹配分析判定规则',
        'sample_title': '📦 抓取样本预览 (十六进制 / 文本)',
        'sample_hex_view': '十六进制视图',
        'sample_text_view': '文本 / ASCII 视图',
        'log_title': '📜 实时日志与探测过程',
        'logs_group_title': '日志',
        'no_port_warning': '未检测到有效串口',
        'port_status_busy': '已占用',
        'dialog_warning_title': '提示',
        'dialog_error_title': '错误',
        'warn_select_port': '请先选择有效的系统串口端口！',
        'warn_port_busy': '该串口已被其他程序占用，请关闭占用程序后刷新端口列表。',
    ...
    'en': {
        ...
        'mode_value_auto': 'Auto / Hybrid',
        'mode_value_passive': 'Passive',
        'mode_value_active': 'Active',
        ...
        'databits_title': 'Data Bits:',
        'chk_databits_8': '8 Bit (Default)',
        'chk_databits_7': '7 Bit',
        ...
        'virtual_port_detected_title': 'ℹ️ Virtual Serial Port Detected: Rec. {baud} bps | {param}',
        'virtual_port_detected_detail': 'Virtual ports transfer data via memory bypassing baudrate clocks. All settings connect. Rec. standard {baud} bps.',
        'log_virtual_port_notice': 'ℹ️ Notice: Current port is a software virtual serial port. All baudrate settings pass validation.',
        'best_card_title_stopping': '⏳ Stopping Detection...',
        'best_card_detail_stopping': 'Stop requested. Closing current serial read and ending the scan.',
        ...
        'sample_hex_view': 'HEX View',
        'sample_text_view': 'Text / ASCII View',
        'log_title': '📜 Live Logs & Status',
        'logs_group_title': 'Logs',
        'no_port_warning': 'No valid serial ports found',
        'port_status_busy': 'Occupied',
        'dialog_warning_title': 'Warning',
        'dialog_error_title': 'Error',
        'warn_select_port': 'Please select a valid serial port first!',
        'warn_port_busy': 'This serial port is occupied by another program. Close it and refresh the port list.',
